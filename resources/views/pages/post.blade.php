    ...
    <div class="row">
      <div class="col-md-8 blog-main">
        ...
        <div class="blog-post">
          ...
          <p class="blog-post-meta">Post by <a href="#">{{ $postWithComments->user->name }}</a> at
            {{ $postWithComments->created_at->toDayDateTimeString() }}</p>
          ...
          @if (Auth()->user()->id == $postWithComments->user_id)
        ...
        <br>
        @guest
        <p> Login to Add a comment. Please click <a href="../login">here</a> to go to the login page.
          @endguest
          ...
          <div class="card shadow-sm" style="padding: 10px;">
            ...
            <div class="card" style="margin-bottom: 5px;">
              <p class="blog-post-meta">Comment by <a href="#"> boss </a> {!!
                $com->created_at->toDayDateTimeString() !!} </p>
              <div class="post-content">
                {!! $com->body !!}
              </div>
            </div>
